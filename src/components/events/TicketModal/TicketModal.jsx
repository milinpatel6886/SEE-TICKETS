...
export default function TicketModal({ eventId, eventTitle, eventImage, eventDate, eventVenue, ticketTypes, onClose }) {
  ...
  const totalAmount = selectedLines.reduce((sum, line) => sum + line.qty * line.ticket.price, 0)
  ...
  return (
    <div className={styles.overlay} onClick={handleOverlayClick}>
      <div className={styles.modal} role="dialog" aria-modal="true" aria-labelledby="ticket-modal-title">
        <div className={styles.header}>
          <div>
            <p className={styles.eyebrow}>Select Tickets</p>
            <h2 id="ticket-modal-title" className={styles.eventTitle}>{eventTitle}</h2>
          </div>
              ...
              <div key={ticket.id} className={styles.ticketRow}>
                ...
                <div className={styles.ticketAction}>
                  ...
                  {qty === 0 ? (
                    ...
                    <div className={styles.stepper} role="group" aria-label={`Quantity for ${ticket.name}`}>
                      <button
                        type="button"
